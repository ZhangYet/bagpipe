...
date = 2024-12-12
lastmod = 2025-01-02T11:14:22+08:00
tags = ["history"]
categories = ["log"]
draft = false
+++
...
今年给 [bpftrace](https://github.com/bpftrace/bpftrace) 提了五个 PR （当然有一个最后关了，但这个 PR 也很有意义，见[我之前的博客](https://dantezy.xyz/posts/ebpf-notes-05/)），
给 [bcc](https://github.com/iovisor/bcc) 提了两个 PR 。
